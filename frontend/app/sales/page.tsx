      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-12 border border-gray-200 dark:border-slate-700 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
            {user?.is_admin ? "Relatório de Vendas" : "Suas Compras"}
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            {user?.is_admin
              ? "Visualize todas as vendas realizadas no sistema, com filtros por usuário, produto e status de pagamento."
              : "Acompanhe o histórico de suas compras e atualizações de status."}
          </p>
